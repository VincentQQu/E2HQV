...
**[Important] Successor: [PIE-Net](https://github.com/VincentQQu/pie-net)** — the next generation of E2HQV with probabilistic intensity-event modeling (PIEM), per-pixel uncertainty, and a pip-installable package (`pip install event-pienet[realtime]`). Pretrained **PIE-Net** and **PIE-Net-Lite** weights are included; real-time demo supported.
